...
class NotificationAdmin(admin.ModelAdmin):
    list_display = ['id', 'user', 'title', 'notification_type', 'is_read', 'priority', 'created_at']
    ...
    fieldsets = (
        ...
        ('Priority & Status', {
            'fields': ('priority', 'is_read', 'read_at', 'is_sent', 'sent_at', 'is_delivered', 'delivered_at')
        }),
        ('FCM', {
...
class UserDeviceAdmin(admin.ModelAdmin):
    list_display = ['id', 'user', 'device_type', 'device_token', 'is_active', 'last_active']
    ...
    fieldsets = (
        ('User', {'fields': ('user',)}),
        ('Device Info', {'fields': ('device_type', 'device_token', 'device_id')}),
        ('Device Details', {'fields': ('app_version', 'os_version', 'model')}),
